document.addEventListener("DOMContentLoaded", function (event) {
   ...
   document.querySelector(".container-fluid").addEventListener("click", function () {
    ...
    (function (global) {
        let restaurant = {};
        let homeContent_link = "http://192.168.43.18:3000/Restaurant%20website/Dynamically%20loaded%20HTML%20website/" +
        ...
        let menuHeading_snippetURL = "http://localhost:3000/Restaurant%20website/Dynamically%20loaded%20" +
            "HTML%20website/HTML%20files/Menu%20categories_heading.html";
        let menuContent_URL = "http://localhost:3000/Restaurant%20website/Dynamically%20loaded%20HTML%20website/" +
